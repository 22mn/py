...
top-level windows have little, icon, iconify/deiconify and protocol for wm events;
...
packed/gridded; Toplevel is like Frame, but new window, and can have a menu;
"""
...
root.title("Lumberjeck demo")
Label(root, text="Main window", width=30).pack()
Button(root, text="Quit All", command=root.destroy).pack()
root.mainloop()