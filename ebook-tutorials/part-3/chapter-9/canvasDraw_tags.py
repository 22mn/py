...
exclusive attention until it returns: others pause if press "r" or "o" duing move; 
"""
...
class CanvasEventsDemo(canvasDraw.CanvasEventsDemo):
	...
	def create_oval_tagged(self, x1,y1,x2,y2):
		...
		self.canvas.itemconfig(objectId, tag="ovals", fill="maroon")
		return objectId

	def create_rectangle_tagged(self, x1,y1,x2,y2):
		objectId = self.canvas.create_rectangle(x1,y1,x2,y2)
		self.canvas.itemconfig(objectId, tag="rectangles", fill="green")
		return objectId
