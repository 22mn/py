...
object, assuem all same max; this is essentially what file selection GUIs do;
"""
...
def viewer(imgdir, kind=Toplevel, cols=None):
	...
	Button(win, text="Quit", command=win.destroy, bg="beige").pack(fill=X)
	return win,savephotos

if __name__ == '__main__':
	imgdir = (len(sys.argv) > 1 and sys.argv[1]) or "pics"
