...
class GuiMaker(Frame):
	...
	def makeMenuBar(self):
		"""
		make menu bar ath the top (Tk8.0 menus below)
	...
	def makeWidgets(self):
		"""
		make 'middle' part last, so menu/toolbar is always on top/bottom
		and clipped last; override this default, pack middle any side;
...
# Self-test when file run standalone: "pythno guimaker.py"
